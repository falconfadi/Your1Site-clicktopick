            ...
            <div class="row d-flex justify-content-center align-items-center ">
                <div class="col-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <p class="mb-0"><span class="text-muted">Sorted by:</span> <a href="#"
                    ...
                    @if(!is_null($cart))
                        ...
                        <div class="card mb-4">
                            <div class="card-body p-4 d-flex flex-row">
                                <div class="cart-action mb-6 " style="padding-top: 50px;">
                                    <a href="{{ route('user.products.index') }}"
                                        class="btn btn-dark btn-rounded btn-icon-left btn-shopping mr-auto">{{ __('front.continue_shopping') }}
                                    ...
                                    <button type="button" class="btn btn-rounded btn-default btn-clear" id="clear-cart"
                                        ...
                                        value="Clear Cart">{{ __('front.clear_cart') }}</button>
                                    ...
                                    <a href="{{ route('checkout') }}"
                                        ...
                                        {{ __('front.checkout') }}<i
                                            class="w-icon-long-arrow-{{ app()->getLocale() == 'en' ? 'right' : 'left' }}"></i></a>
                                </div>
                            </div>
                        </div>
                    @else
