...
@section('content')
    ...
    <div class="container-fluid offer  my-5 py-4">
        <div class="text-center my-4 py-4">
            <h2 class="section-title px-5"><span class="px-2">{{ __('front.offers') }}</span></h2>
        </div>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-primary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        @endif
                        <a href=""
                            class="btn btn-outline-primary text-white py-md-2 px-md-3">{{ __('front.shop_now') }}</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid my-5 py-4 ">
        <div class="text-center my-4 py-4">
            <h2 class="section-title px-5"><span class="px-2">{{ __('front.trandy_products') }}</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0"
                            ...
                            <img class="img-fluid w-100 h-100" src="{{ storageImage($product->featured_image) }}"
                                alt="">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="{{ route('user.products.show', $product) }}" class="btn btn-sm text-dark p-0"><i
    ...
    <!-- Subscribe Start -->
    <div class="container-fluid bg-primary my-5 py-4">
    ...
    <div class="container-fluid my-5 py-4">
        <div class="text-center my-4 py-4">
            <h2 class="section-title px-5"><span class="px-2">{{ __('front.just_arrived') }}</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
            @foreach ($products as $product)
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
