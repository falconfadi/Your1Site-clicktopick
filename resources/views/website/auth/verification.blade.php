                ...
                <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                    ...
                    <div class="tab-content text-center" style="padding:10px">
                        ...
                        <div class="text-center mt-5 ">
                            ...
                            <a href="javascript:void(0);" id="resend_verification_code" data-phone="{{session()->get('user')->phone_number ?? $user->phone_number}}" data-url="{{route('user.resendVerification')}}" style="color: rgb(0, 157, 255);font-size: 12px;">{{__('front.resend')}}</a>
