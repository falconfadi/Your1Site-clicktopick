...
/*!*****************************************!*\
  !*** ./resources/js/filter-products.js ***!
  \*****************************************/
$(document).ready(function () {
  ...
  function getSubCategoriesSpecifications(subcategories) {
    var url = $('#categories_specifications_url').data('url');
    console.log(url);
    var specifications = $('#category_specifications');
    $.ajax({
      url: url,
      type: 'GET',
      data: {
  ...
  function getFilterProducts() {
    var filterMinPrice = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : minPrice;
    var filterMaxPrice = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : maxPrice;
    var filterSubCategories = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : subcategories;
    var filterSpecifications = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : specifications;
    var urlParams = new URLSearchParams(window.location.search);
    ...
    $.ajax({
      ...
      success: function success(data) {
        var count = itemCount(data.products);
        var productsWrapper = $('#product-wrapper');
